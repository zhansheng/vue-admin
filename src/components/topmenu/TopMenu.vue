          ...
          <li>
            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
              <li>
                <a href="#">
                                                    <span class="photo">
                                                        <img src="../../assets/img/avatar2.jpg" class="img-circle"
                                                             alt=""> </span>
                  <span class="subject">
              ...
              <li>
                <a href="#">
                                                    <span class="photo">
                                                        <img src="../../assets/img/avatar3.jpg" class="img-circle"
                                                             alt=""> </span>
                  <span class="subject">
                  ...
                  <span
                    class="message"> Vivamus sed congue nibh auctor nibh congue nibh. auctor nibh auctor nibh... </span>
                </a>
              </li>
              <li>
                <a href="#">
                                                    <span class="photo">
                                                        <img src="../../assets/img/avatar1.jpg" class="img-circle"
                                                             alt=""> </span>
                  <span class="subject">
